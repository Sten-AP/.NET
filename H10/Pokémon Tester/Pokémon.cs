namespace Pokémon_Tester {
	...
	internal class Pokémon {
		...
		public double Average_Full {
			get { return (HP_Full + Attack_Full + Defense_Full + SpAttack_Full + SpDefense_Full + Speed_Full) / 6.0; }
		}
		public int Total {
		...
		public void ShowStats() {
			...
			Console.WriteLine($"Base stats: (average {Average})");
			...
			Console.WriteLine($"Full stats: (average {Average_Full})");
